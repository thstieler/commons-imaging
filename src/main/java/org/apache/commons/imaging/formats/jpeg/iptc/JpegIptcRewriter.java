...
public class JpegIptcRewriter extends JpegRewriter {
    ...
    public void writeIptc(final ByteSource byteSource, final OutputStream os, PhotoshopApp13Data newData)
...

        {
            ...
            final byte[] newBlockBytes = new IptcParser().writeIptcBlock(newData.getRecords(), newData.getForcedCharset());
            ...
            newData = new PhotoshopApp13Data(newData.getRecords(), newBlocks, newData.getForcedCharset());
